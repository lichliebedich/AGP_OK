            ...
            try
            {
                if (gps.Opened)
                {
                    ...
                    if (position != null)
                    {
                        ...
                        {
                            str += "Lat: " + position.Latitude.ToString("00.00000000") + " ";
                        ...
                        {
                            str += "Lon: " + position.Longitude.ToString("00.00000000") + "\r\n";
                        ...
                        switch (fq)
                        {
                            case FixQuality.Unknown: str += "FixQuality: Unknown\r\n";
                                break;
                            case FixQuality.Gps: str += "FixQuality: AGPS\r\n";
                                break;
